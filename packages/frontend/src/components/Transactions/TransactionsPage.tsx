...
export const TransactionsPage = () => {
  ...
  // Show a banner when wallet not connected, but keep the page accessible
  const persisted = (() => {
    try {
    ...
    <Box sx={{ textAlign: 'center', py: 4 }}>
      <Paper elevation={3} sx={{ p: 4, maxWidth: 800, mx: 'auto', borderRadius: 3, mb: 4 }}>
        ...
        <Alert severity="info" sx={{ mt: 1 }}>
          Connect your Stellar wallet to view your transaction history and send payments.
        </Alert>
        <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
          Use the "Connect Wallet" button in the top right corner to get started — you can still view the UI.
        </Typography>
      </Paper>
    </Box>
  ) : null
